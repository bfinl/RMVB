function [reg_min,G,reg_param] = gcv(U,s,b,mod_factor,disp_opt,method)
...
% Set defaults.
if (nargin==5), method='Tikh'; end  % Default method.
...
if (strncmp(method,'Tikh',4) | strncmp(method,'tikh',4))
  ...
  for i=1:npoints
    G(i) = gcvfun(reg_param(i),s2,beta(1:p),delta0,m-n,mod_factor);
  end 
